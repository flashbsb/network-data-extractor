...
echo "Instalando Python3 e Pandas..."
apt-get install -y python3 python3-pip python3-pandas
...
echo "Pronto. Agora você pode rodar o script sem erros de 'ModuleNotFound'."
